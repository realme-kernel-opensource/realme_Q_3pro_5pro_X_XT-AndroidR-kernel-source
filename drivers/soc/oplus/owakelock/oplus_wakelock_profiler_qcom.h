...
#define IRQ_NAME_MODEM_QMI "modem" /* qmi interrupt name of sm7125/sm7150/sm8150，different platform may different.*/
#define IRQ_NAME_MODEM_MODEM "qmi" /* different platform may different */
