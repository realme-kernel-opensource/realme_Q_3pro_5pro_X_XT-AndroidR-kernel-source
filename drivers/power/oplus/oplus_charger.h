...
#elif defined CONFIG_OPLUS_SDM670R_CHARGER
#include "charger_ic/oplus_battery_sdm670R.h"
...
typedef enum {
        ...
        BATTERY_STATUS__NORMAL_PHASE5,	/*40~45C*/
}
...
struct oplus_chg_limits {
	...
	int normal_phase5_bat_decidegc;       /* 40C ~ 45C */
