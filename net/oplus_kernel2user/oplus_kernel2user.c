...
{
    oppo_kernel2user_table_hrd = register_net_sysctl(&init_net, "net/oppo_kernel2user",
...
static int kernel2user_netlink_rcv_msg(struct sk_buff *skb, struct nlmsghdr *nlh)
{
    int ret = 0;
